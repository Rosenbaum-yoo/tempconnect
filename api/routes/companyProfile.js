...
export function createCompanyProfileRouter(deps) {
  ...
  const audit = (req, action, entityType, entityId, details) =>
    writeAudit(pool, { action, entity_type: entityType, entity_id: entityId, actor_id: uid(req), details }).catch(() => {});
  ...
  router.put("/company-profile/overview", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.update", "company_profile", String(data.id), { fields: Object.keys(req.body) });
      ok(res, data);
    } catch (e) {
  ...
  router.put("/company-profile/capabilities", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.capabilities_update", "company_capabilities", String(data.id), null);
      ok(res, data);
    } catch (e) {
  ...
  router.post("/company-profile/locations", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.location_add", "company_location", String(loc.id), { city: loc.city });
      ok(res, loc);
  ...
  router.put("/company-profile/locations/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.location_update", "company_location", req.params.id, null);
      ok(res, loc);
  ...
  router.delete("/company-profile/locations/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.location_delete", "company_location", req.params.id, null);
      ok(res, { deleted: true });
  ...
  router.post("/company-profile/certifications", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.cert_add", "company_certification", String(cert.id), { cert_name: cert.cert_name });
      ok(res, cert);
  ...
  router.put("/company-profile/certifications/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.cert_update", "company_certification", req.params.id, null);
      ok(res, cert);
  ...
  router.delete("/company-profile/certifications/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.cert_delete", "company_certification", req.params.id, null);
      ok(res, { deleted: true });
  ...
  router.post("/company-profile/contacts", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.contact_add", "company_contact", String(c.id), { name: c.name });
      ok(res, c);
  ...
  router.put("/company-profile/contacts/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.contact_update", "company_contact", req.params.id, null);
      ok(res, c);
  ...
  router.delete("/company-profile/contacts/:id", requireAuth, async (req, res) => {
    try {
      ...
      audit(req, "company_profile.contact_delete", "company_contact", req.params.id, null);
      ok(res, { deleted: true });
