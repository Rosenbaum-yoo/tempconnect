...
export function buildOpenApiDocument() {
  ...
  registry.registerPath({ method: "get", path: "/scim/v2/Users", tags: ["Integrations"], summary: "SCIM 2.0: Org-Mitglieder auflisten (Filter userName eq) — Scope admin:scim, nur bei SCIM_ENABLED", responses: { 200: { description: "SCIM ListResponse" }, 401: { description: "Auth fehlt" }, 403: { description: "Scope fehlt" }, 404: { description: "SCIM deaktiviert" } } });
  registry.registerPath({ method: "post", path: "/scim/v2/Users", tags: ["Integrations"], summary: "SCIM 2.0: Nutzer in die Org provisionieren (find-or-create + Mitgliedschaft) — Scope admin:scim", responses: { 201: { description: "User angelegt" }, 200: { description: "User existierte → Mitgliedschaft aktiviert" }, 400: { description: "userName fehlt" }, 401: { description: "Auth fehlt" }, 404: { description: "SCIM deaktiviert" } } });
  registry.registerPath({ method: "patch", path: "/scim/v2/Users/{id}", tags: ["Integrations"], summary: "SCIM 2.0: Mitgliedschaft (de)aktivieren (active) — Scope admin:scim", responses: { 200: { description: "aktualisiert" }, 404: { description: "nicht gefunden / SCIM deaktiviert" } } });
  registry.registerPath({ method: "get", path: "/scim/v2/ServiceProviderConfig", tags: ["Integrations"], summary: "SCIM 2.0: ServiceProviderConfig (Capabilities)", responses: { 200: { description: "SCIM ServiceProviderConfig" }, 404: { description: "SCIM deaktiviert" } } });
