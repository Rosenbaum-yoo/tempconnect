...
TCi18n.register('de', {
  ...
  'exe.vp.mgmt.avgDealSuccess': 'Ø Zuverlässigkeit',
  ...
  'exe.vp.drill.dealSuccess': 'Zuverlässigkeit {value}',
  ...
  'exe.vp.row.dealSuccess': 'Zuverlässigkeit',
...
TCi18n.register('en', {
  ...
  'exe.vp.mgmt.avgDealSuccess': 'Avg reliability',
  'exe.vp.mgmt.topGrades': 'Top grades',
  ...
  'exe.vp.drill.fill': 'Fill {value}',
  'exe.vp.drill.dealSuccess': 'Reliability {value}',
  ...
  'exe.vp.row.readOnly': 'Read-only',
  'exe.vp.row.dealSuccess': 'Reliability',
  'exe.vp.row.activity': 'Activity',
