...
- Status: CODE-SEITIG ERLEDIGT (2026-06-05), uncommitted = Owner-Commit-Gate (Task #23). Owner-approved Variante „drei wie empfohlen": Env-Flag-Gate + Remediation-Migration + subscriptions-RLS-Exclusion bestaetigt.
...
- Status: CODE-SEITIG ERLEDIGT (2026-06-04, Tier-2 nachgezogen 2026-06-05), uncommitted = Owner-Commit-Gate. Bestands-DB-Forward-Repair (Tier-2) jetzt via Migration `126` erledigt.
