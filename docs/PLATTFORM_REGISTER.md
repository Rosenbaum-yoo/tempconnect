...
| Migrationsdateien | **200** | `ls sql/migrations/*.sql \| wc -l` — nummeriert `001_ratings.sql` bis `196_rls_backstop_achtzehn_tabellen.sql`; neun Nummern sind doppelt belegt (`027`/`027b`, `045`/`045b`, `064`, `070`, `074`, `075`, `086`, `130`, `140`). `NUMBERING.md` ist keine Migration |
...
5. **Die Datenbank ist nur gezählt, nicht beschrieben.** 179 Tabellen und 200 Migrationsdateien
