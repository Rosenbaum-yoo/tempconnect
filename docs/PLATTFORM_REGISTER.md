...
| Migrationsdateien | **189** | `ls sql/migrations/*.sql \| wc -l` — nummeriert `001_ratings.sql` bis `185_severity_zurueck_auf_die_vier.sql`; neun Nummern sind doppelt belegt (`027`/`027b`, `045`/`045b`, `064`, `070`, `074`, `075`, `086`, `130`, `140`). `NUMBERING.md` ist keine Migration |
...
5. **Die Datenbank ist nur gezählt, nicht beschrieben.** 180 Tabellen und 189 Migrationsdateien
