...
| 📋 | OpenAPI vollständig + `/api/docs` (Swagger-UI) publiziert | `scripts/generate-openapi.js` (Ausbau) |
| 📋 | `org_erp_mappings` (Org ↔ SAP-Client/DATEV-Mandant) + HR-Outbound-Events (`worker.*`, `*.exported`) | geplant (Welle A) |
