...
| Email / Notification | teilweise | services/emailService.js (nodemailer SMTP), emailHtmlTemplates.js, subscriptionNotificationService.js | console/SMTP ok | **EmailProvider-Abstraktion + SendGrid** | Bounces/Webhook | ok | mittel | **E** | subscriptionNotifications.test | 50 |
