...
> **Diese Datei ist die einzige Go-Live-Checkliste.**
> Technische Details und Befehle stehen in `DEPLOYMENT.md` und `docs/RELEASE_RUNBOOK.md`.
...
- [ ] DR-Dokumentation gelesen: `docs/BACKUP_DISASTER_RECOVERY.md`
...
- `docs/RELEASE_RUNBOOK.md` – Release-, Monitoring- und Rollback-Ablauf
